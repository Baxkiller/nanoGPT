...
# data
dataset = 'openwebtext'
gradient_accumulation_steps = 10 * 8  # used to simulate larger batch sizes
...
if init_from == 'scratch':
    ...
    print(f"Initializing from OpenAI GPT-2 weights: {init_from}", flush = True)
